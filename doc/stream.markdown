...
server](https://iojs.org/dist/v4.0.0/doc/api/http.html#http_http_incomingmessage) is a stream, as is
...
* [http responses, on the client](https://iojs.org/dist/v4.0.0/doc/api/http.html#http_http_incomingmessage)
* [http requests, on the server](https://iojs.org/dist/v4.0.0/doc/api/http.html#http_http_incomingmessage)
* [fs read streams](https://iojs.org/dist/v4.0.0/doc/api/fs.html#fs_class_fs_readstream)
* [zlib streams][]
* [crypto streams][]
* [tcp sockets][]
...
* [http requests, on the client](https://iojs.org/dist/v4.0.0/doc/api/http.html#http_class_http_clientrequest)
* [http responses, on the server](https://iojs.org/dist/v4.0.0/doc/api/http.html#http_class_http_serverresponse)
* [fs write streams](https://iojs.org/dist/v4.0.0/doc/api/fs.html#fs_class_fs_writestream)
* [zlib streams][]
* [crypto streams][]
* [tcp sockets][]
* [child process stdin](https://iojs.org/dist/v4.0.0/doc/api/child_process.html#child_process_child_stdin)
...
[EventEmitter]: https://iojs.org/dist/v4.0.0/doc/api/events.html#events_class_events_eventemitter
...
[tcp sockets]: https://iojs.org/dist/v4.0.0/doc/api/net.html#net_class_net_socket
[zlib streams]: zlib.html
[zlib]: zlib.html
[crypto streams]: crypto.html
[crypto]: crypto.html
[tls.CryptoStream]: https://iojs.org/dist/v4.0.0/doc/api/tls.html#tls_class_cryptostream
[process.stdin]: https://iojs.org/dist/v4.0.0/doc/api/process.html#process_process_stdin
[stdout]: https://iojs.org/dist/v4.0.0/doc/api/process.html#process_process_stdout
[process.stdout]: https://iojs.org/dist/v4.0.0/doc/api/process.html#process_process_stdout
[process.stderr]: https://iojs.org/dist/v4.0.0/doc/api/process.html#process_process_stderr
[child process stdout and stderr]: https://iojs.org/dist/v4.0.0/doc/api/child_process.html#child_process_child_stdout
...
[_write]: #stream_writable_write_chunk_encoding_callback_1
[`util.inherits`]: https://iojs.org/dist/v4.0.0/doc/api/util.html#util_util_inherits_constructor_superconstructor
