...
[`EventEmitter`]: https://nodejs.org/docs/v5.5.0/api/events.html#events_class_events_eventemitter
[`pause()`]: #stream_readable_pause
[`pipe()`]: #stream_readable_pipe_destination_options
[`process.stderr`]: https://nodejs.org/docs/v5.5.0/api/process.html#process_process_stderr
[`process.stdin`]: https://nodejs.org/docs/v5.5.0/api/process.html#process_process_stdin
[`process.stdout`]: https://nodejs.org/docs/v5.5.0/api/process.html#process_process_stdout
[`readable.resume()`]: #stream_readable_resume
[`resume()`]: #stream_readable_resume
[`stdout`]: https://nodejs.org/docs/v5.5.0/api/process.html#process_process_stdout
...
[`tls.CryptoStream`]: https://nodejs.org/docs/v5.5.0/api/tls.html#tls_class_cryptostream
[`unpipe()`]: #stream_readable_unpipe_destination
[`unpipe()`]: #stream_readable_unpipe_destination
[`util.inherits`]: https://nodejs.org/docs/v5.5.0/api/util.html#util_util_inherits_constructor_superconstructor
...
[child process stdin]: https://nodejs.org/docs/v5.5.0/api/child_process.html#child_process_child_stdin
[child process stdout and stderr]: https://nodejs.org/docs/v5.5.0/api/child_process.html#child_process_child_stdout
[Compatibility]: #stream_compatibility_with_older_node_js_versions
[crypto streams]: crypto.html
[crypto]: crypto.html
[Duplex]: #stream_class_stream_duplex
[fs read streams]: https://nodejs.org/docs/v5.5.0/api/fs.html#fs_class_fs_readstream
[fs write streams]: https://nodejs.org/docs/v5.5.0/api/fs.html#fs_class_fs_writestream
[http requests, on the client]: https://nodejs.org/docs/v5.5.0/api/http.html#http_class_http_clientrequest
[http requests, on the server]: https://nodejs.org/docs/v5.5.0/api/http.html#http_http_incomingmessage
[http responses, on the client]: https://nodejs.org/docs/v5.5.0/api/http.html#http_http_incomingmessage
[http responses, on the server]: https://nodejs.org/docs/v5.5.0/api/http.html#http_class_http_serverresponse
[Object mode]: #stream_object_mode
[Readable]: #stream_class_stream_readable
[request to an HTTP server]: https://nodejs.org/docs/v5.5.0/api/http.html#http_http_incomingmessage
[SimpleProtocol v2]: #stream_example_simpleprotocol_parser_v2
[tcp sockets]: https://nodejs.org/docs/v5.5.0/api/net.html#net_class_net_socket
