...
import { Readable, PassThrough, pipeline } from "../../readable-deno.js";
...
async function tests() {
  ...
  }
  {
    ...
    for await (const a of r) {} // eslint-disable-next-line no-unused-vars
  ...
  }
  {
    ...
    const d = b.next();
    r.push(null);
    assert.deepStrictEqual(await c, {
      done: true,
      value: undefined
    });
    assert.deepStrictEqual(await d, {
      done: true,
      value: undefined
    });
  }
