    ...
    get: function () {
      ...
      if (exports.inFreeBSDJail) {
        ...
        if (process.env.LOCALHOST) {
          localhostIPv4 = process.env.LOCALHOST;} else 
        {
...
if (exports.isWindows) {
  ...
  if (process.env.TEST_THREAD_ID) {
    exports.PIPE += '.' + process.env.TEST_THREAD_ID;}} else 
...
if (exports.isWindows) {
  exports.faketimeCli = false;} else 
{
...
exports.spawnCat = function (options) {
  ...
  if (exports.isWindows) {
    return spawn('more', [], options);} else 
  {
...
exports.spawnSyncCat = function (options) {
  ...
  if (exports.isWindows) {
    return spawnSync('more', [], options);} else 
  {
...
exports.spawnPwd = function (options) {
  ...
  if (exports.isWindows) {
    return spawn('cmd.exe', ['/c', 'cd'], options);} else 
  {
...
function ArrayStream() {
  this.run = function (data) {var _this = this;
...
exports.nodeProcessAborted = function nodeProcessAborted(exitCode, signal) {
  ...
  if (signal !== null) {
    return expectedSignals.indexOf(signal) > -1;} else 
  {
